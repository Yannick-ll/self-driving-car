...
3. Quelques concepts sur la reconnaissance d'image en Computer Vision, le coeur de notre système de navigation : [lien](https://deepomatic.com/fr/quest-ce-que-la-reconnaissance-dimage)
